...
return new class extends Migration
{
    ...
    {
        Schema::create('sprf_archive_items', function (Blueprint $table) {
            $table->id();

            $table->foreignId('project_id')->constrained('sprf_archive_projects')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('sprf_archive_items');
    }
};