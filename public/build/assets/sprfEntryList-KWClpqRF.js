import{r as d,a as F,j as t,H as ve,b as je}from"./app-kOHlJQVL.js";import{F as we,A as Ne}from"./AuthenticatedLayout-CLFXbZ55.js";import{s as E}from"./index-BsxvijQw.js";import{P as ke}from"./ProjectListSection-z6ak56_7.js";import{g as De,e as Ee}from"./index-CZCenfY5.js";import{h as Ce,c as Se}from"./index-DZc9d2jI.js";import{a as Ae}from"./index-CY35uhuR.js";import{M as te,e as se,h as Fe,i as $e,C as ae,d as Me}from"./index-CHbi1GRS.js";import"./iconBase-DTrHQFZw.js";import"./chevron-down-B7-Zs19C.js";const re=e=>{if(!e)return"—";const s=new Date(e),l=Math.floor((new Date-s)/1e3);if(l<60)return"Just now";const o=Math.floor(l/60);if(o<60)return`${o}m ago`;const i=Math.floor(o/60);if(i<24)return`${i}hr${i>1?"s":""} ago`;const n=Math.floor(i/24);return n<30?`${n}d ago`:new Intl.DateTimeFormat("en-US",{month:"2-digit",day:"2-digit",year:"2-digit"}).format(s)};let _e={data:""},Pe=e=>{if(typeof window=="object"){let s=(e?e.querySelector("#_goober"):window._goober)||Object.assign(document.createElement("style"),{innerHTML:" ",id:"_goober"});return s.nonce=window.__nonce__,s.parentNode||(e||document.head).appendChild(s),s.firstChild}return e||_e},Te=/(?:([\u0080-\uFFFF\w-%@]+) *:? *([^{;]+?);|([^;}{]*?) *{)|(}\s*)/g,Le=/\/\*[^]*?\*\/|  +/g,ne=/\n+/g,M=(e,s)=>{let a="",l="",o="";for(let i in e){let n=e[i];i[0]=="@"?i[1]=="i"?a=i+" "+n+";":l+=i[1]=="f"?M(n,i):i+"{"+M(n,i[1]=="k"?"":s)+"}":typeof n=="object"?l+=M(n,s?s.replace(/([^,])+/g,c=>i.replace(/([^,]*:\S+\([^)]*\))|([^,])+/g,u=>/&/.test(u)?u.replace(/&/g,c):c?c+" "+u:u)):i):n!=null&&(i=/^--/.test(i)?i:i.replace(/[A-Z]/g,"-$&").toLowerCase(),o+=M.p?M.p(i,n):i+":"+n+";")}return a+(s&&o?s+"{"+o+"}":o)+l},C={},oe=e=>{if(typeof e=="object"){let s="";for(let a in e)s+=a+oe(e[a]);return s}return e},Ie=(e,s,a,l,o)=>{let i=oe(e),n=C[i]||(C[i]=(u=>{let p=0,x=11;for(;p<u.length;)x=101*x+u.charCodeAt(p++)>>>0;return"go"+x})(i));if(!C[n]){let u=i!==e?e:(p=>{let x,m,f=[{}];for(;x=Te.exec(p.replace(Le,""));)x[4]?f.shift():x[3]?(m=x[3].replace(ne," ").trim(),f.unshift(f[0][m]=f[0][m]||{})):f[0][x[1]]=x[2].replace(ne," ").trim();return f[0]})(e);C[n]=M(o?{["@keyframes "+n]:u}:u,a?"":"."+n)}let c=a&&C.g?C.g:null;return a&&(C.g=C[n]),((u,p,x,m)=>{m?p.data=p.data.replace(m,u):p.data.indexOf(u)===-1&&(p.data=x?u+p.data:p.data+u)})(C[n],s,l,c),n},Oe=(e,s,a)=>e.reduce((l,o,i)=>{let n=s[i];if(n&&n.call){let c=n(a),u=c&&c.props&&c.props.className||/^go/.test(c)&&c;n=u?"."+u:c&&typeof c=="object"?c.props?"":M(c,""):c===!1?"":c}return l+o+(n??"")},"");function q(e){let s=this||{},a=e.call?e(s.p):e;return Ie(a.unshift?a.raw?Oe(a,[].slice.call(arguments,1),s.p):a.reduce((l,o)=>Object.assign(l,o&&o.call?o(s.p):o),{}):a,Pe(s.target),s.g,s.o,s.k)}let le,V,X;q.bind({g:1});let S=q.bind({k:1});function ze(e,s,a,l){M.p=s,le=e,V=a,X=l}function _(e,s){let a=this||{};return function(){let l=arguments;function o(i,n){let c=Object.assign({},i),u=c.className||o.className;a.p=Object.assign({theme:V&&V()},c),a.o=/ *go\d+/.test(u),c.className=q.apply(a,l)+(u?" "+u:"");let p=e;return e[0]&&(p=c.as||e,delete c.as),X&&p[0]&&X(c),le(p,c)}return s?s(o):o}}var Re=e=>typeof e=="function",W=(e,s)=>Re(e)?e(s):e,Be=(()=>{let e=0;return()=>(++e).toString()})(),ie=(()=>{let e;return()=>{if(e===void 0&&typeof window<"u"){let s=matchMedia("(prefers-reduced-motion: reduce)");e=!s||s.matches}return e}})(),He=20,Z="default",de=(e,s)=>{let{toastLimit:a}=e.settings;switch(s.type){case 0:return{...e,toasts:[s.toast,...e.toasts].slice(0,a)};case 1:return{...e,toasts:e.toasts.map(n=>n.id===s.toast.id?{...n,...s.toast}:n)};case 2:let{toast:l}=s;return de(e,{type:e.toasts.find(n=>n.id===l.id)?1:0,toast:l});case 3:let{toastId:o}=s;return{...e,toasts:e.toasts.map(n=>n.id===o||o===void 0?{...n,dismissed:!0,visible:!1}:n)};case 4:return s.toastId===void 0?{...e,toasts:[]}:{...e,toasts:e.toasts.filter(n=>n.id!==s.toastId)};case 5:return{...e,pausedAt:s.time};case 6:let i=s.time-(e.pausedAt||0);return{...e,pausedAt:void 0,toasts:e.toasts.map(n=>({...n,pauseDuration:n.pauseDuration+i}))}}},U=[],ce={toasts:[],pausedAt:void 0,settings:{toastLimit:He}},k={},ue=(e,s=Z)=>{k[s]=de(k[s]||ce,e),U.forEach(([a,l])=>{a===s&&l(k[s])})},me=e=>Object.keys(k).forEach(s=>ue(e,s)),Ue=e=>Object.keys(k).find(s=>k[s].toasts.some(a=>a.id===e)),Y=(e=Z)=>s=>{ue(s,e)},We={blank:4e3,error:4e3,success:2e3,loading:1/0,custom:4e3},qe=(e={},s=Z)=>{let[a,l]=d.useState(k[s]||ce),o=d.useRef(k[s]);d.useEffect(()=>(o.current!==k[s]&&l(k[s]),U.push([s,l]),()=>{let n=U.findIndex(([c])=>c===s);n>-1&&U.splice(n,1)}),[s]);let i=a.toasts.map(n=>{var c,u,p;return{...e,...e[n.type],...n,removeDelay:n.removeDelay||((c=e[n.type])==null?void 0:c.removeDelay)||e?.removeDelay,duration:n.duration||((u=e[n.type])==null?void 0:u.duration)||e?.duration||We[n.type],style:{...e.style,...(p=e[n.type])==null?void 0:p.style,...n.style}}});return{...a,toasts:i}},Ye=(e,s="blank",a)=>({createdAt:Date.now(),visible:!0,dismissed:!1,type:s,ariaProps:{role:"status","aria-live":"polite"},message:e,pauseDuration:0,...a,id:a?.id||Be()}),L=e=>(s,a)=>{let l=Ye(s,e,a);return Y(l.toasterId||Ue(l.id))({type:2,toast:l}),l.id},g=(e,s)=>L("blank")(e,s);g.error=L("error");g.success=L("success");g.loading=L("loading");g.custom=L("custom");g.dismiss=(e,s)=>{let a={type:3,toastId:e};s?Y(s)(a):me(a)};g.dismissAll=e=>g.dismiss(void 0,e);g.remove=(e,s)=>{let a={type:4,toastId:e};s?Y(s)(a):me(a)};g.removeAll=e=>g.remove(void 0,e);g.promise=(e,s,a)=>{let l=g.loading(s.loading,{...a,...a?.loading});return typeof e=="function"&&(e=e()),e.then(o=>{let i=s.success?W(s.success,o):void 0;return i?g.success(i,{id:l,...a,...a?.success}):g.dismiss(l),o}).catch(o=>{let i=s.error?W(s.error,o):void 0;i?g.error(i,{id:l,...a,...a?.error}):g.dismiss(l)}),e};var Ge=1e3,Ke=(e,s="default")=>{let{toasts:a,pausedAt:l}=qe(e,s),o=d.useRef(new Map).current,i=d.useCallback((m,f=Ge)=>{if(o.has(m))return;let b=setTimeout(()=>{o.delete(m),n({type:4,toastId:m})},f);o.set(m,b)},[]);d.useEffect(()=>{if(l)return;let m=Date.now(),f=a.map(b=>{if(b.duration===1/0)return;let D=(b.duration||0)+b.pauseDuration-(m-b.createdAt);if(D<0){b.visible&&g.dismiss(b.id);return}return setTimeout(()=>g.dismiss(b.id,s),D)});return()=>{f.forEach(b=>b&&clearTimeout(b))}},[a,l,s]);let n=d.useCallback(Y(s),[s]),c=d.useCallback(()=>{n({type:5,time:Date.now()})},[n]),u=d.useCallback((m,f)=>{n({type:1,toast:{id:m,height:f}})},[n]),p=d.useCallback(()=>{l&&n({type:6,time:Date.now()})},[l,n]),x=d.useCallback((m,f)=>{let{reverseOrder:b=!1,gutter:D=8,defaultPosition:I}=f||{},v=a.filter(j=>(j.position||I)===(m.position||I)&&j.height),O=v.findIndex(j=>j.id===m.id),w=v.filter((j,T)=>T<O&&j.visible).length;return v.filter(j=>j.visible).slice(...b?[w+1]:[0,w]).reduce((j,T)=>j+(T.height||0)+D,0)},[a]);return d.useEffect(()=>{a.forEach(m=>{if(m.dismissed)i(m.id,m.removeDelay);else{let f=o.get(m.id);f&&(clearTimeout(f),o.delete(m.id))}})},[a,i]),{toasts:a,handlers:{updateHeight:u,startPause:c,endPause:p,calculateOffset:x}}},Ve=S`
from {
...
`,ut="0%{opacity:0;} 100%{opacity:1;}",mt="0%{opacity:1;} 100%{opacity:0;}",pt=_("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
