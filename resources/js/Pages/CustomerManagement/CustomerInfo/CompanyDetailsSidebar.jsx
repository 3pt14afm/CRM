...
export default function CompanyDetailsSidebar({ isOpen, company, onClose }) {
    ...
    return (
        <>
            ...
            <div className={`fixed inset-y-0 right-4 z-50 w-full max-w-[500px] my-5 bg-gradient-to-br from-[#FDFDFD] via-[#e9f1e5] to-[#FDFDFD] animate-moving-gradient shadow-[-10px_0_20px_rgba(0,0,0,0.05)] border-l border-b border-black/15 flex flex-col rounded-3xl transform transition-transform duration-500 ease-out  ${ isOpen ? 'translate-x-0' : 'translate-x-[120%]' }`}>
                ...
                <div className="px-7 p-3.5 flex justify-between flex-shrink-0 bg-[#F2FAEE] rounded-t-3xl shadow-sm">
                ...
                {/* Scrollable Body */}
                <div className="flex-1 overflow-y-auto px-8 pt-5 pb-10 [&::-webkit-scrollbar]:w-0 hover:[&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-[#195c0059]">
                    {company ? (
                        <div className="flex flex-col">
                            ...
                            {/* Key Stats Card */}
                            <div className="mt-5 bg-[#F2FAEE] backdrop-blur-sm rounded-2xl py-3 px-4 flex justify-around items-center border border-[#00000010] border-b-black/20 border-r-black/20 shadow-[-2px_-2px_10px_rgba(245,245,245,0.8),0px_0px_0_rgba(255,255,255,0.8),2px_2px_4px_rgba(0,0,0,0.2)]">
                            ...
                            {/* Branches Card */}
                            <div className="mt-4 border border-[#00000010] border-b-black/20 border-r-black/20 shadow-[-2px_-2px_10px_rgba(245,245,245,0.8),0px_0px_0_rgba(255,255,255,0.8),2px_2px_4px_rgba(0,0,0,0.2)] rounded-2xl bg-[#F2FAEE] backdrop-blur-sm overflow-hidden pb-5">
