...
function Yields({ buttonClicked, readOnly }) {
  ...
  return (
    <div className="w-full">
      <div className="w-full sm:max-w-sm md:max-w-md overflow-hidden rounded-xl shadow-md border border-[#2c2c2e]/15 border-b-[#2c2c2e]/25 bg-white">
        <table className="w-full border-separate border-spacing-0 table-fixed">
          <colgroup>
            <col className="w-[10%] sm:w-[25%] min-w-24" />
            <col className="w-[45%] sm:w-[37.5%] min-w-32" />
            <col className="w-[45%] sm:w-[37.5%] min-w-20" />
          </colgroup>

          <thead>
            <tr className="bg-[#F6FDF5]">
              <th className="border-b border-r border-slate-200 p-3 sm:p-5" />
              <th className="border-b border-r border-slate-200 text-[10px] xl:text-[11px] p-2 font-bold text-slate-800 text-center uppercase tracking-wider">
                Monthly Yields
              </th>
              <th className="border-b border-slate-200 p-2 text-[10px] xl:text-[11px] font-bold text-slate-800 text-center uppercase tracking-wider">
                Annual Yields
              </th>
            </tr>
          </thead>
          ...
          <tbody>
            ...
            <tr className="text-center">
              <td className="bg-[#E9F7E7] text-[11px] xl:text-[12px] px-2 border-b border-r border-slate-200 font-bold text-slate-800">
                Mono AMPV
              </td>
            ...
            {/* Color AMVP */}
            <tr className="text-center">
              <td className="bg-[#E9F7E7] text-[11px] xl:text-[12px] px-2 border-r border-slate-200 font-bold text-slate-800">
                Color AMPV
              </td>
