...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "group/calendar bg-[var(--plain)] rounded-lg p-2 [--cell-radius:calc(var(--radius)_-_2px)] [--cell-size:1.75rem]",
        className
      )}
      ...
      classNames={{
        ...
        dropdown: cn("absolute !text-xs inset-0 bg-white opacity-0", defaultClassNames.dropdown),
