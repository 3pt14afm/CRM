...
export default function SprfItemsTable2({
  ...
  const getSellingPriceError = (groupIndex, subIndex) => {
    return errors?.[`items.${groupIndex}.subitems.${subIndex}.sellingPricePerUnit`];
  };
                  ...
                  <td className="border-t border-r border-darkgreen/15 px-1">
                    {readOnly ? (
                      ...
                      <input
                        ...
                        className={`${inputClass} py-0.5 ${getQtyError(groupIndex, subIndex) && Number(sub.qty || 0) < 1 ? '!border-red-500 !border-solid' : ''}`}
                        placeholder="0"
                      />
                    )}
                  </td>
                  ...
                  <td className="border-t border-r border-darkgreen/15 px-1">
                    {readOnly ? (
                      ...
                      <input
                        ...
                        className={`${inputClass} py-0.5 ${getSellingPriceError(groupIndex, subIndex) ? '!border-red-500 !border-solid' : ''}`}
                        placeholder="0.00"
                      />
                    )}
                  </td>
