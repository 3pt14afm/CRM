...
export default function ForceChangePasswordModal() {
  const { mustChangePassword, defaultPasswordLoginCount } = usePage().props;

  const shouldShow = mustChangePassword || defaultPasswordLoginCount > 0;
  ...
  const message = useMemo(() => {
    if (mustChangePassword || defaultPasswordLoginCount >= 3) {
    ...
    return 'Please change your default password.';
  }, [mustChangePassword, defaultPasswordLoginCount]);
